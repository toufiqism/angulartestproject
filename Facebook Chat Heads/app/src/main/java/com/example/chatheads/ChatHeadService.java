...
public class ChatHeadService extends Service {
    ...
    static DevicePolicyManager deviceMangerGlobal;

    public ChatHeadService() {
    }

    public static void getDeviceManager(DevicePolicyManager deviceManger) {
        deviceMangerGlobal = deviceManger;
    }
